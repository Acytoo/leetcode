...
class Solution {
 public:
  string shortestCompletingWord(string licensePlate, vector<string>& words) {
    ...
    //   else if (words[i] == "bad")
    //     cout << i << " bad " << endl;
    stable_sort(words.begin(), words.end(), [&words](const string& a, const string& b) {
